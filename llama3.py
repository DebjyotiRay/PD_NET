...
prompt = f"Answer the following biomedical question in a very specific manner, like do not explain anything extra unless specifically asked in the user query; make sure when causes or specific gene names are asked you should return ONLY THE NAMES and provide citations to support your answer, supported by their links as well:\n\n{user_input}"
